...
public class SampleRunTest extends Base {
    static int item_count=0;
    static String username="standard_user",password="secret_sauce",first_name="Darshika",last_name="B",pin_code="560092";
    static double item_1_price,item_2_price;
    public static void verify_login(String username, String password) throws Exception {
    ...
    public static void selection_and_conformation() throws Exception{
        ...
        // back page by clicking continue shopping
        ...
        // first lowest product
        click("(//div[@class='inventory_item'])[1]//button");
        item_count += 1;
        // getting number shows in cart icon
